...
;; $Id: xterm-title.el,v 1.2 2005/11/18 10:15:48 cwyang Exp $
...
(defun xterm-title-update ()
  ...
  (unless (and xterm-title-mode
    ...
    (xterm-set-window-title
     (my-format-mode-line (or xterm-title-frame-title-format
    ...
    (xterm-set-icon-title
     (my-format-mode-line (or xterm-title-icon-title-format
